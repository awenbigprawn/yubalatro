...
love.update = function(dt)
    ...
    local ok, err = pcall(function()
        ...
        elseif qa_step == 3 then
            ...
            for _, key in ipairs({'hand_size', 'hands', 'dollars'}) do
        ...
        elseif qa_step == 5 then
            ...
            YUBALATRO.draft = {hand_size = '12', hands = '8', dollars = '1000'}
        ...
        elseif qa_step == 6 then
            ...
            report('NEW RUN OK: hand_size=12 hands=8 dollars=1000')
            screenshot('new-run')
            G.GAME.dollars = 731
            save_run()
        ...
        elseif qa_step == 8 then
            ...
            report('CONTINUE OK: original hand_size=12 hands=8 dollars=731 preserved')
